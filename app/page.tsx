...
export default async function Home() {
  ...
  return (
    ...
    <main className="min-h-screen bg-hiyu-cream text-hiyu-dark selection:bg-hiyu-rose selection:text-white relative scroll-smooth">
      ...
      {/* ========================================= */}
      {/* FOOTER SECTION (Tambahan Baru) */}
      {/* ========================================= */}
      <footer className="bg-hiyu-dark text-hiyu-cream pt-16 pb-8 px-6 md:px-12 rounded-t-[2.5rem] mt-24 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-hiyu-cream/20 pb-12">
          
          {/* Kolom 1: Brand Info */}
          <div>
            <h3 className="font-serif text-3xl font-bold tracking-tight mb-4">
              HiYu <span className="text-hiyu-rose italic">Gift</span>
            </h3>
            <p className="text-sm text-hiyu-cream/70 leading-relaxed pr-4">
              Merangkai momen berharga menjadi kenangan tak terlupakan melalui koleksi balon premium dan kado personalisasi untuk orang tersayang.
            </p>
          </div>

          {/* Kolom 2: Quick Links */}
          <div>
            <h4 className="font-serif text-xl mb-4 text-hiyu-rose">Tautan Cepat</h4>
            <div className="flex flex-col gap-3 text-sm text-hiyu-cream/80">
              <a href="#koleksi" className="hover:text-hiyu-rose hover:translate-x-1 transition-all">Koleksi Kami</a>
              <a href="#cara-pesan" className="hover:text-hiyu-rose hover:translate-x-1 transition-all">Cara Pemesanan</a>
              <a href="#testimoni" className="hover:text-hiyu-rose hover:translate-x-1 transition-all">Testimoni Pelanggan</a>
            </div>
          </div>

          {/* Kolom 3: Kontak & Sosmed */}
          <div>
            <h4 className="font-serif text-xl mb-4 text-hiyu-rose">Hubungi Kami</h4>
            <div className="flex flex-col gap-3 text-sm text-hiyu-cream/80 mb-6">
              <p>📍 Buleleng, Bali, Indonesia</p>
              <p>📱 +62 888 0890 0908</p>
            </div>
            
            {/* Ikon Sosmed (Instagram & Facebook dummy) */}
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-hiyu-cream/10 flex items-center justify-center hover:bg-hiyu-rose hover:-translate-y-1 transition-all">
                {/* Ikon Instagram SVG */}
        ...
        {/* Copyright */}
        <div className="text-center mt-8 text-xs text-hiyu-cream/50 tracking-wider">
          &copy; {new Date().getFullYear()} HiYu Gift. All rights reserved.
        </div>
      </footer>
